...
public partial class AcademyGroupContext : DbContext
{
    ...
    public virtual DbSet<AcademyGroup> AcademyGroups { get; set; }

    public virtual DbSet<Student> Students { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server=localhost\\SQLEXPRESS;Database=AcademyGroup;Integrated Security=SSPI;TrustServerCertificate=true");
